...
(
    ...
    [string] $project = "CASA",
    [string] $release = '2.0.16.0',
    [string] $fixVersion = "2nd Chance CY17 Release 5 James Monroe",
    [string] $component = "2nd Chance CY17 Release 5 James Monroe",
