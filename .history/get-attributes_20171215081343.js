 ...
 * Demonstrates use of request-promise, accepting oauth token from stdin, making synchronous a promised function
...
var promisedAttributes = util.promisify( getAttributes )

async function main()
{
    var theAttributes = await promisedAttributes( program.hostname, authToken )
