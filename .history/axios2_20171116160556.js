...
axios.all( [isEmail1Available(), isEmail2Available(), getFlorence()] )
    .then( axios.spread( function ( emailAvailableOne, emailAvailableTwo, florence )
    {
        ...
        console.log(florence.data.results[0].formatted_address)
        //     `City: ${florence.results[0].formatted_address} -`,
        //     `Latitude: ${florence.results[0].geometry.location.lat} -`,
        //     `Longitude: ${florence.results[0].geometry.location.lng}`
        // )
