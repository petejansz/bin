...
if (program.firstname) qs.firstName = encodeURI(program.firstname ? program.firstname : null)
if (program.lastname)  qs.lastName = encodeURI(program.lastname ? program.lastname : null)
