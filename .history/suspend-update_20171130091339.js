...
updateCustomerContacts += "  set status = 1, last_updated = current timestamp\n"
...
updateCustomerServices += "  set service_status_id = 1, last_updated = current timestamp\n"
...
function updateDbPlayers( playerIdList )
{
