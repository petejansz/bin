...
program
    .version( '0.0.1' )
    .description( 'admin get player Id, get enums' )
    .usage( ' ARGS ' )
    .option( '-e, --enums', 'Get enums' )
...
if ( program.enums )
{
    lib1.getAdminEnums( adminEnumsResponseHandler )
}
else if ( program.username && program.hostname )
{
    pd2admin.getPlayerId( program.username, program.hostname, program.port, getPlayerIdResponseHandler, errorHandler )
}
else
{
    program.help()
