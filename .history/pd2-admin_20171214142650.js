...
program
    .version( '0.0.1' )
    .description( 'NodeJS CLI to pd2-admin get enums, get playerId, make note, search-players' )
    .usage( ' ARGS ' )
...
if ( program.api == 'close' )
{
    ...
    closeAccount( pdAdminSystem, program.playerid, closeAccountResponseHandler )
}
