...
getOauth( oauthAxiosInstance, 'test50@yopmail.com', 'Password123', getOAuthResponseHandler )
...
async function getOauth( oauthAxiosInstance, username, password )
{
    ...
    {
        getOAuthResponseHandler( response )
    } )
}

function getOAuthResponseHandler( response )
{
