...
const directionsRequest = axios.get('https://maps.googleapis.com/maps/api/directions/json?origin=place_id:' + this.state.sacLocation.results.place_id + '&destination=place_id:' + this.state.fresLocation.results.place_id)
