...
(
    ...
    [string] $template = "wiki://TPST/SDORSEY_TEST_GP_14_Compliant_Release_Notes_Template_Extra_Fields",
    [switch]    $help,
    [switch]    $h
)
