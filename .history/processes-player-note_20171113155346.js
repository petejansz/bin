...
var request = require( process.env.USERPROFILE + '/AppData/Roaming/npm/node_modules/sync-request' )
...
addNote(program.hostname, program.playerId)
...
function addNote( host, playerId, noteText )
{
    ...
    var noteId = JSON.parse(response.getBody('utf8'))
    console.log(noteId)
