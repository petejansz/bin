...
const cat2Auth = 'ESMS GRROWP4M5D6NH5IMHX1YBHNIJJEVQ8'
var auth = devAuth

if (program.hostname.match(/'cat1'/))
{
...
else if (program.hostname.match(/'cat2'/))
{
...
var url = proto + '://' + program.hostname + ':' + port + '/california-admin-rest/api/v1/admin/players'
