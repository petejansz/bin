...
function getLoginToken( hostname, jsonRequestBody, responseHandler )
{
    var options =
        {
            "method": "POST",
...
var jsonRequestBody =
{
    ...
    resourceOwnerCredentials: { USERNAME: program.username, PASSWORD: program. }
};

getLoginToken( program.hostname, jsonRequestBody, responseHandler );