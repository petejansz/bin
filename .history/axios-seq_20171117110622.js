...
const directionsRequest = axios.get('https://maps.googleapis.com/maps/api/directions/json?origin=place_id:' + this.setState.sacLocation.data.results[0].place_id + '&destination=place_id:' + fresLocation.data.results[0].place_id)
