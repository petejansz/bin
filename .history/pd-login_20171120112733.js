...
function getOauth( host, username, password )
{
    ...
    var axiosInstance = axios.create( {
        baseURL: proto + '://' + host,
        headers: lib1.commonHeaders //{ 'X-EX-SYSTEM-ID': '8', 'X-CHANNEL-ID': '2', 'X-SITE-ID': '35' }
    } )

    axiosInstance.post( '/api/v1/oauth/login', data ).then( function ( response1 )
    {
        console.log(response1.data[0].authCode)
    } )
}
